...
const CONFIG = {
  ...
  tagline:
    "I help businesses achieve their goals through thoughtful design, strategic thinking, and meticulous execution.",
  ...
  youtubeUrl: "https://youtube.com/@apexsollutions?si=uiuHRYowNRjEVodB",
  instagramUrl: "https://www.instagram.com/apex.sollutions?utm_source=qr",
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-gray-700">
          ...
          <p className="text-gray-400 mb-8">
            Enter your home specs to get an estimate
          </p>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-2">
                ...
                {visits === 2 &&
                  "Twice yearly (recommended for Clovis climate)"}
            ...
            <div className="bg-black rounded-lg p-6 border-2 border-red-600">
              ...
              <p className="text-gray-500 text-xs">
                *Exact price determined after site inspection
              </p>
            </div>
            ...
            <div>
              ...
              >
                Contact APEX Solutions
              </button>
              <p className="text-gray-500 text-xs mt-3 text-center">
                View our availability and schedule your service
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-black text-white py-12 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-gray-700">
          ...
          <p className="text-gray-400 mb-8">
            Tell us about your gutters to get an estimate
          </p>
          ...
          <div className="space-y-8">
                ...
                {Object.keys(gutterSizes).map((size) => (
                  ...
                  >
                    ...
                    <div className="text-xs opacity-80">
                      {gutterSizes[size].sqft}
                    </div>
                  </button>
                ))}
              </div>
              <p className="text-gray-400 text-sm mt-3">
                {gutterSize === "below-average" &&
                  "Smaller home with less gutter coverage"}
                {gutterSize === "average" &&
                  "Standard residential home - most common"}
                {gutterSize === "above-average" &&
                  "Large home or extensive gutter system"}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-2">
                ...
                {stories === 2 &&
                  "Two levels - requires extension ladders or lift equipment"}
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <span className="text-gray-300">
                    Heavy Mud/Years of Neglect (+$50-$75)
                  </span>
                </label>
              </div>
              <p className="text-gray-400 text-sm mt-2">
                Regular debris like leaves, twigs, and dirt is included in our
                standard service. We only charge extra for exceptional buildup.
              </p>
            </div>
...
function CarDetailingCalculator({ onBack, onNavigate }) {
  ...
  let minPrice =
    (currentVehicle.pricing && currentVehicle.pricing[quality]?.min) || 0;
  let maxPrice =
    (currentVehicle.pricing && currentVehicle.pricing[quality]?.max) || 0;

  // Add-ons
  const bedCleaningPrice =
    deepBedCleaning &&
    ["small-truck", "truck"].includes(vehicleType) &&
    currentVehicle.bedCleaning
      ? {
          min: currentVehicle.bedCleaning.min,
          max: currentVehicle.bedCleaning.max,
        }
      : { min: 0, max: 0 };
  const petHairPrice =
    petHairDetail && currentVehicle.petHair && currentVehicle.petHair[quality]
      ? {
          min: currentVehicle.petHair[quality].min,
          max: currentVehicle.petHair[quality].max,
        }
      : { min: 0, max: 0 };

  // Engine bay adds $40 to max price only
  const engineBayPrice = engineBayDetail
    ? { min: 0, max: 40 }
    : { min: 0, max: 0 };

  // Polish pricing (only for premium, and varies by vehicle) - wax is included free with Premium
  const polishPrice =
    polishDetail && quality === "premium" && polishPricing[vehicleType]
      ? {
          min: polishPricing[vehicleType].min,
          max: polishPricing[vehicleType].max,
        }
      : { min: 0, max: 0 };

  const totalMin =
    minPrice +
    bedCleaningPrice.min +
    petHairPrice.min +
    engineBayPrice.min +
    polishPrice.min;
  const totalMax =
    maxPrice +
    bedCleaningPrice.max +
    petHairPrice.max +
    engineBayPrice.max +
    polishPrice.max;
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-gray-700">
          ...
          <p className="text-gray-400 mb-2">
            Select your vehicle and service level to get an estimate
          </p>
          <p className="text-red-400 text-sm mb-8">
            Note: extreme cases will require a quote
          </p>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              {quality === "basic" && (
                <p className="text-gray-400 text-sm mt-3">
                  Note: unless you're scheduling two services together, Basic
                  Detail is not available as a mobile appointment.
                </p>
              )}
            </div>
                ...
                <div className="space-y-3">
                  {["small-truck", "truck"].includes(vehicleType) && (
                    <label className="flex items-center gap-3 cursor-pointer">
                      ...
                      />
                      <span className="text-gray-300">
                        Deep Bed Cleaning (+${currentVehicle.bedCleaning.min}-$
                        {currentVehicle.bedCleaning.max})
                      </span>
                    </label>
                  )}
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    />
                    <span className="text-gray-300">
                      Pet Hair Detail - Perfect Finish (+$
                      {currentVehicle.petHair[quality]?.min}-$
                      {currentVehicle.petHair[quality]?.max})
                    </span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                    ...
                    />
                    <span className="text-gray-300">
                      Engine Bay Cleaning (Quote)
                    </span>
                  </label>
                </div>
                <p className="text-gray-500 text-sm mt-3 italic">
                  *Pet hair detail recommended if your vehicle has dog or cat
                  hair
                </p>
              </div>
            )}
              ...
              <div className="space-y-4">
                ...
                <div className="bg-red-900 bg-opacity-20 rounded-lg p-4 border border-red-700">
                  <p className="text-red-200 font-bold mb-2">
                    🛡️ Wax Protection Included
                  </p>
                  <p className="text-gray-300 text-sm">
                    Premium wax coating for superior protection and lasting
                    shine. Hydrophobic and UV-protected finish.
                  </p>
                </div>
                  ...
                  <div>
                    <span className="text-gray-300">
                      ...
                      {currentVehicle.contactForQuote
                        ? "(Quote)"
                        : `(+$${polishPricing[vehicleType]?.min || "?"})`}
                    </span>
                    <p className="text-gray-500 text-xs">
                      Enhanced polish for maximum shine and perfection
                    </p>
                  </div>
                </label>
              </div>
            ...
            {currentVehicle.showAddOns && (
              <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
                <p className="text-white font-medium mb-3">
                  ✓ Included in {qualityTiers[quality].label}:
                </p>
                <ul className="space-y-2 text-gray-300 text-sm">
                  {quality === "basic" && (
                    <>
              ...
              {currentVehicle.contactForQuote ? (
                <div className="text-center">
                  ...
                  <p className="text-gray-300 mb-4">
                    Each {currentVehicle.label} is unique. We'll provide a
                    detailed, personalized estimate after discussing your
                    specific needs.
                  </p>
                  <button
                    onClick={() => onNavigate("contact")}
                ...
                <>
                        ...
                        {deepBedCleaning && currentVehicle.bedCleaning && (
                          <div className="flex justify-between">
                            ...
                            <span className="text-green-400">
                              +${currentVehicle.bedCleaning.min}-$
                              {currentVehicle.bedCleaning.max}
                            </span>
                          </div>
                        )}
                  ...
                  <p className="text-gray-500 text-xs">
                    *Exact price determined after vehicle inspection
                  </p>
                </>
              )}
            </div>
...
function WindowCalculator({ onBack, onNavigate }) {
  ...
  const screenPrice = screenCleaning
    ? { min: 20, max: 40 }
    : { min: 0, max: 0 };
  const hardWaterPrice = hardWaterTreatment
    ? { min: 15, max: 100 }
    : { min: 0, max: 0 };
  ...
  if (!isQuote) {
    if (stories === 2) {
      ...
      const base =
        serviceType === "exterior" ? currentRange.exterior : currentRange.both;
      minPrice = base.min + screenPrice.min + hardWaterPrice.min;
      maxPrice = base.max + screenPrice.max + hardWaterPrice.max;
    }
  }
    ...
    <div className="min-h-screen bg-black text-white py-12 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-gray-700">
          ...
          <p className="text-gray-400 mb-8">
            Crystal-clear, streak-free windows inside and out
          </p>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-3">
                Count every window pane you want cleaned - not sure? We'll count
                during the visit.
              </p>
            </div>
            ...
            {!isQuote && (
              <>
                ...
                <div>
                  ...
                  {stories === 2 && (
                    <p className="text-gray-400 text-sm mt-3">
                      2-story homes are priced flat due to the extra equipment
                      and safety precautions needed - not per window.
                    </p>
                  )}
                </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setHardWaterTreatment(e.target.checked)
                        }
                        className="w-4 h-4"
                      />
                      <span className="text-gray-300">
                        Hard Water Spot Removal (+$15-$100)
                      </span>
                    </label>
                  </div>
                  <p className="text-gray-400 text-sm mt-3">
                    Clovis has extremely hard water - if your windows have white
                    mineral spots that won't wipe off, this treatment restores
                    the glass.
                  </p>
                </div>
              </>
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
              ...
              <ul className="space-y-2 text-gray-300 text-sm">
                ...
                {serviceType === "both" && !isQuote && (
                  <li>• Interior glass hand-detailed</li>
                )}
              </ul>
            </div>
            ...
            <div className="bg-black rounded-lg p-6 border-2 border-red-600">
              ...
              {isQuote ? (
                <div className="mb-4">
                  ...
                  <p className="text-gray-400 text-sm mt-3">
                    Larger homes deserve an accurate price - we'll do a quick
                    walkthrough and give you an exact number.
                  </p>
                </div>
              ) : (
                <div className="flex items-baseline gap-2 mb-6">
    ...
    <div className="min-h-screen bg-black text-white py-12 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-gray-700">
          ...
          <p className="text-gray-400 mb-8">
            Bring your turf back to life - fresh, clean, and odor-free
          </p>
            ...
            {!isQuote && (
              <div className="border-t border-gray-700 pt-6">
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <span className="text-gray-300">
                    Pet Odor Deep Treatment (+$40-$75)
                  </span>
                </label>
                <p className="text-gray-400 text-sm mt-3">
                  Enzyme-based treatment that neutralizes pet urine odor at the
                  source - highly recommended for homes with dogs.
                </p>
              </div>
            )}
            ...
            <div className="bg-black rounded-lg p-6 border-2 border-red-600">
              ...
              {isQuote ? (
                <div className="mb-4">
                  ...
                  <p className="text-gray-400 text-sm mt-3">
                    Large turf installations vary - we'll measure and give you
                    an exact price.
                  </p>
                </div>
              ) : (
...
function GarageCalculator({ onBack, onNavigate }) {
  ...
  const degreasingPrice = degreasing
    ? { min: 30, max: 60 }
    : { min: 0, max: 0 };
    ...
    <div className="min-h-screen bg-black text-white py-12 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-gray-700">
          ...
          <p className="text-gray-400 mb-8">
            Deep-cleaned concrete that looks like new
          </p>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-3">
                Note: Garage must be cleared of vehicles and belongings before
                service (we can work around large shelving).
              </p>
            </div>
            ...
            <div className="border-t border-gray-700 pt-6">
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                />
                <span className="text-gray-300">
                  Oil Stain & Degreasing Treatment (+$30-$60)
                </span>
              </label>
              <p className="text-gray-400 text-sm mt-3">
                Heavy-duty degreaser applied to oil spots and stains before
                pressure washing - dramatically improves results on stained
                concrete.
              </p>
            </div>
    ...
    <div className="min-h-screen bg-black text-white py-12 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-gray-700">
          ...
          <p className="text-gray-400 mb-8">
            Blast away years of dirt, stains, and grime
          </p>
          ...
          <div className="space-y-8">
            ...
            {!isQuote && (
              <>
                ...
                <div>
                  ...
                  {surfaceType === "driveway" && (
                    <p className="text-gray-400 text-sm mt-3">
                      For larger driveways with 4+ car capacity, we'll need to
                      bring significant amounts of water - let's get a custom
                      quote.
                    </p>
                  )}
                  {surfaceType === "patio" && (
                    <p className="text-gray-400 text-sm mt-3">
                      Patio pricing includes sidewalks and walkways adjacent to
                      the patio.
                    </p>
                  )}
                </div>
                ...
                <div className="border-t border-gray-700 pt-6">
                  ...
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    />
                    <span className="text-gray-300">
                      Heavy Stain Treatment - Oil, Rust, Gum (+$20-$80)
                    </span>
                  </label>
                  <p className="text-gray-400 text-sm mt-3">
                    Pre-treatment for stubborn stains that pressure alone won't
                    remove.
                  </p>
                </div>
              </>
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
              ...
              <ul className="space-y-2 text-gray-300 text-sm">
                <li>
                  • Professional surface cleaner - even, streak-free finish
                </li>
            ...
            <div className="bg-black rounded-lg p-6 border-2 border-red-600">
              ...
              {isQuote ? (
                <div className="mb-4">
                  ...
                  <p className="text-gray-400 text-sm mt-3">
                    For driveways that fit 4+ cars, we need to bring intense
                    amounts of water. Let's discuss your driveway and provide a
                    custom rate.
                  </p>
                </div>
              ) : (
    ...
    <div className="min-h-screen bg-black text-white py-12 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-gray-700">
          ...
          <p className="text-gray-400 mb-8">
            Say goodbye to the smell - sanitized, deodorized bins at your curb
          </p>
            ...
            <div className="bg-black rounded-lg p-6 border-2 border-red-600">
              ...
              {isQuote ? (
                <div className="mb-4">
                  ...
                  <p className="text-gray-400 text-sm mt-3">
                    Got a large industrial account, HOA, or commercial property?
                    We'll build you a custom rate.
                  </p>
                </div>
              ) : (
              ...
              <p className="text-gray-500 text-xs">
                *Price varies mainly based on distance needed to travel
              </p>
            </div>
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-white">
      <div className="text-center">
        ...
        <div className="mt-12">
          ...
          <a
            href={`mailto:?body=Check%20out%20my%20portfolio%20at%20${encodeURIComponent(
              websiteUrl
            )}`}
        ...
        {menuOpen && (
          <div className="md:hidden bg-black border-t border-gray-800">
            <div className="px-6 py-4 space-y-3">
              <button
                onClick={() => scrollToSection("our-work")}
                className="block w-full text-left hover:text-red-600 py-2"
              >
                Our Work
              </button>
              <button
              ...
              <button
                onClick={() => scrollToSection("contact")}
                className="block w-full bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700 text-center"
              >
                Contact
              </button>
            </div>
      ...
      <section className="pt-32 pb-16 px-6 bg-black relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <p className="text-red-600 font-bold uppercase tracking-widest text-sm mb-4">
            Clovis, CA · Exterior Cleaning & Detailing
          </p>
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            Clean That <span className="text-red-600">Speaks</span> For Itself
          </h1>
          <p className="text-lg md:text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
            Spot-free windows, solar panels, and vehicles powered by pure water
            technology. Instant online estimates, honest pricing, local service.
          </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-400">
              Real before-and-after transformations on our social pages
            </p>
          </div>
      ...
      <section id="pricing" className="py-20 px-6 bg-gray-900">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-red-600 mx-auto mb-6"></div>
            <p className="text-lg text-gray-400">
              Tap any service for an instant price estimate - no phone call
              required
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="rounded-xl p-7 bg-gradient-to-br from-red-600 to-red-800 text-left flex flex-col justify-center">
              ...
              <p className="text-red-100 text-sm mb-5 leading-relaxed">
                Booking two or more services on the same visit? Ask about our
                bundle discounts - the more we do, the more you save.
              </p>
              <button
                onClick={() => scrollToSection("contact")}
            ...
            <div className="rounded-xl p-7 bg-gradient-to-br from-gray-800 to-black border border-red-600 text-left flex flex-col justify-center">
              ...
              <p className="text-gray-300 text-sm mb-5 leading-relaxed">
                Refer us to a friend and get refunded 25% of your service - up
                to $50 back in your pocket when their job is complete.
              </p>
              <button
                onClick={() => scrollToSection("contact")}
            ...
            <div className="rounded-xl p-7 bg-gradient-to-br from-gray-800 to-black border border-red-600 text-left flex flex-col justify-center">
              ...
              <p className="text-gray-300 text-sm mb-5 leading-relaxed">
                Follow us on Instagram and show us at your appointment - we'll
                knock 5% off your service, just for keeping up with our work.
              </p>
              <a
                href={CONFIG.instagramUrl}
                target="_blank"
          ...
          <p className="text-center text-gray-400 mt-12 text-sm">
            💡 Get an instant estimate above, then call or text us to lock in
            your spot!
          </p>
        </div>
      </section>
      ...
      <section id="contact" className="py-20 px-6 bg-black">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-red-600 mx-auto mb-6"></div>
            <p className="text-lg text-gray-400">
              Got your estimate? Call or text and we'll get you on the schedule.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="bg-gray-900 rounded-lg p-8 border border-gray-700">
                ...
                <div className="mb-6">
                  ...
                  <a
                    href={`sms:${CONFIG.phone}?body=Hi%20APEX%20Solutions!%20I%20just%20got%20an%20estimate%20on%20your%20site%20and%20I'd%20like%20to%20schedule%20a%20service.`}
                    className="inline-block bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition font-medium"
                  >
                    Send Text Message
                  </a>
                  <p className="text-gray-500 text-sm mt-2">
                    Fastest way to reach us - send photos of the job for an
                    accurate quote
                  </p>
                </div>
